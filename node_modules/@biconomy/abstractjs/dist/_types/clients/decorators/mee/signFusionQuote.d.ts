...
import { type SignOnChainQuotePayload, type SignOnChainQuoteParams } from "./signOnChainQuote";
 ...
 */
export type SignFusionQuoteParameters = SignPermitQuoteParams | SignOnChainQuoteParams;
/**
 * Union type for the payload returned by signFusionQuote
 */
export type SignFusionQuotePayload = SignOnChainQuotePayload | SignPermitQuotePayload;
/**
 ...
 */
export declare const signFusionQuote: (client: BaseMeeClient, parameters: SignFusionQuoteParameters) => Promise<SignFusionQuotePayload>;
export default signFusionQuote;
//# sourceMappingURL=signFusionQuote.d.ts.map