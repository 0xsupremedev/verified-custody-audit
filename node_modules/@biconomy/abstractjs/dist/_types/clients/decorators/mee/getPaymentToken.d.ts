 ...
 */
export declare const getPaymentToken: (client: BaseMeeClient, parameters: GetPaymentTokenParams) => Promise<GetPaymentTokenPayload>;
export default getPaymentToken;
//# sourceMappingURL=getPaymentToken.d.ts.map