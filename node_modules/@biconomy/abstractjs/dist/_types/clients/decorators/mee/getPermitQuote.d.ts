 ...
 */
export type GetPermitQuotePayload = {
 ...
 */
export declare const getPermitQuote: (client: BaseMeeClient, parameters: GetPermitQuoteParams) => Promise<GetPermitQuotePayload>;
export default getPermitQuote;
//# sourceMappingURL=getPermitQuote.d.ts.map