...
import { type ExecuteFusionQuoteParams, type ExecuteFusionQuotePayload } from "./executeFusionQuote";
import { type ExecuteSignedQuoteParams, type ExecuteSignedQuotePayload } from "./executeSignedQuote";
import { type GetFusionQuoteParams, type GetFusionQuotePayload } from "./getFusionQuote";
import { type GetGasTokenParams, type GetGasTokenPayload } from "./getGasToken";
import { type GetOnChainQuoteParams, type GetOnChainQuotePayload } from "./getOnChainQuote.js";
import { type GetPaymentTokenParams, type GetPaymentTokenPayload } from "./getPaymentToken";
import { type GetPermitQuoteParams, type GetPermitQuotePayload } from "./getPermitQuote";
import { type GetQuoteParams, type GetQuotePayload } from "./getQuote";
import { type GetSupertransactionReceiptParams, type GetSupertransactionReceiptPayload } from "./getSupertransactionReceipt";
import { type SignFusionQuotePayload, type SignFusionQuoteParameters } from "./signFusionQuote";
import { type SignOnChainQuoteParams, type SignOnChainQuotePayload } from "./signOnChainQuote.js";
import { type SignPermitQuoteParams, type SignPermitQuotePayload } from "./signPermitQuote";
import { type SignQuotePayload, type SignQuoteParams } from "./signQuote";
import { type WaitForSupertransactionReceiptParams, type WaitForSupertransactionReceiptPayload } from "./waitForSupertransactionReceipt";
/**
...
export type MeeActions = {
     ...
     * @returns Promise resolving to signed quote data
     */
    signOnChainQuote: (params: SignOnChainQuoteParams) => Promise<SignOnChainQuotePayload>;
    /**
     ...
     */
    signPermitQuote: (params: SignPermitQuoteParams) => Promise<SignPermitQuotePayload>;
    /**
     ...
     */
    getPermitQuote: (params: GetPermitQuoteParams) => Promise<GetPermitQuotePayload>;
    /**
     ...
     */
    getPaymentToken: <EParams extends GetPaymentTokenParams>(params: EParams) => Promise<GetPaymentTokenPayload>;
    /**
     ...
     */
    getOnChainQuote: (params: GetOnChainQuoteParams) => Promise<GetOnChainQuotePayload>;
    /**
     ...
     */
    signFusionQuote: (params: SignFusionQuoteParameters) => Promise<SignFusionQuotePayload>;
    /**
 ...
 */
export declare const meeActions: (meeClient: BaseMeeClient) => MeeActions;
