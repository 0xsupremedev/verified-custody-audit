 ...
 */
export type GetFusionQuotePayload = GetPermitQuotePayload | GetOnChainQuotePayload;
/**
 ...
 */
export declare const getFusionQuote: (client: BaseMeeClient, parameters: GetFusionQuoteParams) => Promise<GetFusionQuotePayload>;
export default getFusionQuote;
//# sourceMappingURL=getFusionQuote.d.ts.map