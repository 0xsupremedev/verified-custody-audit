...
export declare const NEXUS_BOOTSTRAP_ADDRESS: Hex;
export declare const MEE_VALIDATOR_ADDRESS: Hex;
export declare const BICONOMY_ATTESTER_ADDRESS: Hex;
export declare const BICONOMY_ATTESTER_ADDRESS_UNTIL_0_1: Hex;
export declare const NEXUS_ACCOUNT_FACTORY_ADDRESS: Hex;
export declare const COMPOSABLE_MODULE_ADDRESS: Hex;
export declare const NEXUS_IMPLEMENTATION_ADDRESS: Hex;
