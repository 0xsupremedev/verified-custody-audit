 ...
 * ```
 */
export declare const buildTransferFrom: (baseParams: BaseInstructionsParams, parameters: BuildTransferFromParameters, forceComposableEncoding?: boolean, efficientMode?: boolean) => Promise<Instruction[]>;
export default buildTransferFrom;
//# sourceMappingURL=buildTransferFrom.d.ts.map