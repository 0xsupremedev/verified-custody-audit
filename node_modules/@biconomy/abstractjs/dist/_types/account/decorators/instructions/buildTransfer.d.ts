 ...
 * ```
 */
export declare const buildTransfer: (baseParams: BaseInstructionsParams, parameters: BuildTransferParameters, forceComposableEncoding?: boolean, efficientMode?: boolean) => Promise<Instruction[]>;
