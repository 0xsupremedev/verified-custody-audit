...
export declare const GLOBAL_COMPOSABLE_CALLS: {
    ...
    readonly toInstallModuleCalls: (account: ModularSmartAccount, { address, initData, type }: import("../../../modules/utils/Types").ModuleMeta) => Promise<Call[]>;
    readonly toUninstallModuleCalls: (account: ModularSmartAccount, { address, deInitData, type }: import("../../../modules/utils/Types").ModuleMeta) => Promise<Call[]>;
    readonly toInstallWithSafeSenderCalls: (account: ModularSmartAccount, { address, initData, type }: import("../../../modules/utils/Types").ModuleMeta) => Promise<Call[]>;
    readonly toSafeSenderCalls: (__: ModularSmartAccount, { address }: import("../../../modules/utils/Types").ModuleMeta) => Promise<Call[]>;
    readonly toUninstallFallbackCalls: (account: ModularSmartAccount, { address, initData, type }: import("../../../modules/utils/Types").ModuleMeta) => Promise<Call[]>;
};
