 ...
 * ```
 */
export declare const buildWithdrawal: (baseParams: BaseInstructionsParams, parameters: BuildWithdrawalParameters, forceComposableEncoding?: boolean, efficientMode?: boolean) => Promise<Instruction[]>;
export default buildWithdrawal;
//# sourceMappingURL=buildWithdrawal.d.ts.map