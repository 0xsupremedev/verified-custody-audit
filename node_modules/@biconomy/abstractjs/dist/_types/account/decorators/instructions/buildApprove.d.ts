 ...
 * ```
 */
export declare const buildApprove: (baseParams: BaseInstructionsParams, parameters: BuildApproveParameters, forceComposableEncoding?: boolean, efficientMode?: boolean) => Promise<Instruction[]>;
