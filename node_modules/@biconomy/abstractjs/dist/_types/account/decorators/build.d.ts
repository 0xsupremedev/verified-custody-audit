...
export type BaseInstructionTypes = BuildIntentInstruction | BuildTransferFromInstruction | BuildTransferInstruction | BuildApproveInstruction | BuildWithdrawalInstruction | BuildBatchInstruction | BuildMultichainInstructionInstruction;
/**
 * Union type of all possible build instruction types
 */
export type BuildInstructionTypes = BaseInstructionTypes | BuildDefaultInstruction;
/**
 * Union type of all possible build composable instruction types
 */
export type BuildComposableInstructionTypes = BaseInstructionTypes | BuildComposableInstruction | BuildComposableRawInstruction;
/**
...
export declare const buildComposable: (baseParams: BaseInstructionsParams, parameters: BuildComposableInstructionTypes) => Promise<Instruction[]>;
