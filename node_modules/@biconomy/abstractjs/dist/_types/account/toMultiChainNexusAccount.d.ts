...
import { type DelegationParams, type ToNexusSmartAccountParameters } from "./toNexusAccount";
 ...
 */
export type MultichainNexusParams = Partial<Omit<ToNexusSmartAccountParameters, "signer">> & {
