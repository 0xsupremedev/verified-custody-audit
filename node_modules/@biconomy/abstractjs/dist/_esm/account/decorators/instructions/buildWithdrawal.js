...
import { addressEquals } from "../../utils/index.js";
 ...
 * ```
 */
export const buildWithdrawal = async (baseParams, parameters, forceComposableEncoding = false, efficientMode = true) => {
    ...
    const isNativeToken = addressEquals(tokenAddress, "0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee");
    let triggerCalls;
    if (isNativeToken) {
