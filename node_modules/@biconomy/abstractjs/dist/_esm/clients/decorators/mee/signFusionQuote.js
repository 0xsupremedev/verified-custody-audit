...
export const signFusionQuote = async (client, parameters) => {
    const paymentTokenInfo = await getPaymentToken(client, parameters.fusionQuote.trigger);
    ...
    if (paymentTokenInfo.paymentToken) {
        ...
        permitEnabled = await isPermitSupported(modularSmartAccount.walletClient, parameters.fusionQuote.trigger.tokenAddress);
    }
    else {
