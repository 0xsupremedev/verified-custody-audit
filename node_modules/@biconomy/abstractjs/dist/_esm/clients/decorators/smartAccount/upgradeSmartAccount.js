...
import { NEXUS_IMPLEMENTATION_ADDRESS } from "../../../constants/index.js";
/**
...
export async function upgradeSmartAccount(client, parameters) {
    const { account: account_ = client.account, maxFeePerGas, maxPriorityFeePerGas, nonce, implementationAddress = NEXUS_IMPLEMENTATION_ADDRESS, initData = "0x", ...rest } = parameters ?? {};
    if (!account_) {
