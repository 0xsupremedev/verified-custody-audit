...
async function upgradeSmartAccount(client, parameters) {
    const { account: account_ = client.account, maxFeePerGas, maxPriorityFeePerGas, nonce, implementationAddress = constants_1.NEXUS_IMPLEMENTATION_ADDRESS, initData = "0x", ...rest } = parameters ?? {};
    if (!account_) {
